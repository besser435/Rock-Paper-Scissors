...
I use class/def so they can be collapsed in the IDE. I probably still used it wrong lol


V1.5 (IFT101 Verion) Changelog:
Merged rigged version (1.4.1) to main so its one program
Removed HAL anomaly
...
enable_sounds = 0
match_point = 3
p_comp_play_rigged = ["rock", "rock", "paper", "scissors"] # from 33% chance of rock to 50%
...
def operation_Astroid2():
    ...
    time.sleep(0.3)
    print("Operation Astroid2 Complete.")
    time.sleep(1)
